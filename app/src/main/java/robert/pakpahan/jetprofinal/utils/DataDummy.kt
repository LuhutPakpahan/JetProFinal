...
import robert.pakpahan.jetprofinal.source.remote.response.movie.*
import robert.pakpahan.jetprofinal.source.remote.response.movie.Genre
import robert.pakpahan.jetprofinal.source.remote.response.movie.ProductionCompany
import robert.pakpahan.jetprofinal.source.remote.response.movie.ProductionCountry
import robert.pakpahan.jetprofinal.source.remote.response.movie.SpokenLanguage
import robert.pakpahan.jetprofinal.source.remote.response.tvshow.*

typealias TvShowGenre = robert.pakpahan.jetprofinal.source.remote.response.tvshow.Genre
typealias TvShowProductionCompany = robert.pakpahan.jetprofinal.source.remote.response.tvshow.ProductionCompany
typealias TvShowProductionCountry = robert.pakpahan.jetprofinal.source.remote.response.tvshow.ProductionCountry
typealias TvShowSpokenLanguage = robert.pakpahan.jetprofinal.source.remote.response.tvshow.SpokenLanguage
